            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">
                  {t('company.blog.featured.title')}
                </h2>
                <p className="text-neutral-600 dark:text-neutral-300 mb-6">
                  {t('company.blog.featured.excerpt')}
                </p>
                <div className="flex items-center gap-4 text-sm text-neutral-500 dark:text-neutral-400">
                  <span>{t('company.blog.featured.date')}</span>
                  <span>•</span>
                  <span>{t('company.blog.featured.readTime')}</span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 overflow-hidden">
              <div className="bg-neutral-100 dark:bg-neutral-700 p-8 text-center">
                <div className="w-12 h-12 bg-secondary-100 dark:bg-secondary-900 rounded-lg flex items-center justify-center mx-auto">
              ...
              <div className="p-6">
                <span className="px-2 py-1 bg-secondary-100 dark:bg-secondary-900 text-secondary-700 dark:text-secondary-300 text-xs rounded-full mb-3 inline-block">
                  {t('company.blog.article1.category')}
                </span>
                <h3 className="font-semibold text-neutral-900 dark:text-white mb-3">
                  {t('company.blog.article1.title')}
                </h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-300 mb-4">
                  {t('company.blog.article1.excerpt')}
                </p>
                <div className="flex items-center gap-2 text-xs text-neutral-500 dark:text-neutral-400">
                  <span>{t('company.blog.article1.date')}</span>
                  <span>•</span>
                  <span>{t('company.blog.article1.readTime')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 overflow-hidden">
              ...
              <div className="p-6">
                <span className="px-2 py-1 bg-emerald-100 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 text-xs rounded-full mb-3 inline-block">
                  {t('company.blog.article2.category')}
                </span>
                <h3 className="font-semibold text-neutral-900 dark:text-white mb-3">
                  {t('company.blog.article2.title')}
                </h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-300 mb-4">
                  {t('company.blog.article2.excerpt')}
                </p>
                <div className="flex items-center gap-2 text-xs text-neutral-500 dark:text-neutral-400">
                  <span>{t('company.blog.article2.date')}</span>
                  <span>•</span>
                  <span>{t('company.blog.article2.readTime')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 overflow-hidden">
              ...
              <div className="p-6">
                <span className="px-2 py-1 bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 text-xs rounded-full mb-3 inline-block">
                  {t('company.blog.article3.category')}
                </span>
                <h3 className="font-semibold text-neutral-900 dark:text-white mb-3">
                  {t('company.blog.article3.title')}
                </h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-300 mb-4">
                  {t('company.blog.article3.excerpt')}
                </p>
                <div className="flex items-center gap-2 text-xs text-neutral-500 dark:text-neutral-400">
                  <span>{t('company.blog.article3.date')}</span>
                  <span>•</span>
                  <span>{t('company.blog.article3.readTime')}</span>
                </div>
              </div>
            </div>
          </div>
