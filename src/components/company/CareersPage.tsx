...
export function CareersPage() {
  ...
  const createMailtoLink = () => {
    const subject = encodeURIComponent(t('company.careers.position.applySubject').toString());
    const body = encodeURIComponent(t('company.careers.position.applyBody').toString());
